...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16-Set-2023 às 01:24
...
CREATE TABLE `tbl_produtos` (
  ...
  `Preço_Prod` decimal(5,0) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
ALTER TABLE `tbl_clientes`
  ADD CONSTRAINT `tbl_clientes_ibfk_1` FOREIGN KEY (`ID_Cliente`) REFERENCES `tbl_vendas` (`ID_Cliente`);
